...
int pushbuttons_pin[] = {
  6, //up
  7, //down
  8, //brenschluss throttle zero (the pushbutton on the translation handle)
  //9, //brenschluss throttle zero (the pushbutton on the translation handle)
  //4, //(locking toggle on frontplate)
  //5, //(locking toggle on frontplate)
  3, //throttle full (pushbutton on frontplate)
  //2, //throttle full (pushbutton on frontplate)
};
